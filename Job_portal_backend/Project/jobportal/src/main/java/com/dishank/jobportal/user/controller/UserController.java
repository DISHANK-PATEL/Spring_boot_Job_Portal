package com.dishank.jobportal.user.controller;
...
public class UserController {
    ...
    public ResponseEntity<byte[]> getProfilePicture(Authentication authentication) {
        String userEmail = authentication.getName();
        com.dishank.jobportal.dto.ProfileDto profileDto = userService.getProfilePicture(userEmail);
    ...
    public ResponseEntity<byte[]> getResume(Authentication authentication) {
        String userEmail = authentication.getName();
        com.dishank.jobportal.dto.ProfileDto profileDto = userService.getResume(userEmail);
